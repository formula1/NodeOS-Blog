...
function getCacheData(e,r){try{var t=localStorage.getItem(e)}catch(n){return setTimeout(r.bind(r,n),1)}if(!t||/^\[?undefined(?:\]?)$|\[\]|\[?null(?:\]?)$/.test(t))return setTimeout(r.bind(r,"empty"),1);try{t=JSON.parse(t)}catch(n){return setTimeout(r.bind(r,n),1)}Array.isArray(t)||(t=[t]),setTimeout(r.bind(r,void 0,t),1)}function UriIterator(e,r,t){r.timestamp2URI(e,function(e){jQuery.get(e).done(function(e){Array.isArray(e)||(e=[e]),async.eachSeries(e,function(e,t){r.prep(e,function(){t()})},function(r){t(r,e)})}).fail(r.error.bind(r.error))})}function finalize(e,r,t,n){try{localStorage.setItem(e,JSON.stringify(r))}catch(i){return}async.eachSeries(r,function(e,r){t.ready(e,r)},n)}var async=require("async"),version=1,userversion=localStorage.getItem("cacheorUri-version");(!userversion||"undefined"===userversion||version>userversion)&&localStorage.clear(),localStorage.setItem("cacheorUri-version",version);var checkArrayOrder=function(e){return!e||e.length<2?"unk":e[0].timestamp<e[1].timestamp?"asc":"desc"};module.exports=function(e,r){getCacheData(e,function(t,n){var i;t?n=[]:i="desc"==checkArrayOrder(n)?n[0].timestamp:n[n.length-1].timestamp,UriIterator(i,r,function(t,a){if(t)return r.error(t);var o=reOrderAndConsolidate(n,a);finalize(e,o,r,function(e){return e?r.error(t):0===o.length?r.done(i):"desc"==checkArrayOrder(o)?r.done(o.shift().timestamp):void r.done(o.pop().timestamp)})})})},module.exports.reOrderAndConsolidate=function(e,r){var t,n=checkArrayOrder(e),i=checkArrayOrder(r);return"unk"==n&&"unk"==i?t="asc":n==i&&(t=i),"unk"==n||"unk"==i?t="unk"==n?i:n:n!=i&&(e.sort(function(e,r){return"asc"==i?e.timestamp-r.timestamp:r.timestamp-e.timestamp}),t=i),"asc"==t?e.concat(r):r.concat(e)};
